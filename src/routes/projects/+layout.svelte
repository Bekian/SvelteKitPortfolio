    ...
    <nav class="bg-gray-500">
          ...
          <div class="flex items-center">
            <div class="hidden md:block">
              <div class="ml-10 flex items-baseline space-x-4">
                ...
                <a href="/" class=" text-gray-900 hover:bg-gray-700 hover:text-white rounded-md px-3 py-2 text-sm font-medium" aria-current="page">Home</a>
                <a href="/projects" class="bg-gray-900 text-white rounded-md px-3 py-2 text-sm font-medium">Projects</a>
      ...
      <div class="md:hidden" id="mobile-menu">
        <div class="space-y-1 px-2 pb-3 pt-2 sm:px-3">
          ...
          <a href="/contacts" class="text-gray-300 hover:bg-gray-700 hover:text-white block rounded-md px-3 py-2 text-base font-medium">Contact</a>
        </div>
        <div class="border-t border-gray-700 pb-3 pt-4">
          <div class="flex items-center px-5">
            <div class="ml-3">
              <div class="text-base font-medium leading-none text-white">Bekian</div>
              <div class="text-sm font-medium leading-none text-gray-400">sample@example.com</div>
            </div>
